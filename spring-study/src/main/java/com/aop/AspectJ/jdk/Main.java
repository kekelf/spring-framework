...
public class Main {
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext ac = new ClassPathXmlApplicationContext("aop/AspectJ/jdk/aop.xml");
		TestAspectJInterface ta = (TestAspectJInterface)ac.getBean("testAspectJ");
		ta.myShowAspectJ();
